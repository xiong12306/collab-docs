      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24">
          ...
          <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
            安全找回<br />
            <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">你的账户</span>
          </h2>
          <p className="text-lg text-slate-400 leading-relaxed max-w-md">
            验证邮箱后即可重置密码，全程加密保障你的账户安全。
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-slate-50 px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-1.5">输入注册邮箱来找回你的账户</p>
          </div>
